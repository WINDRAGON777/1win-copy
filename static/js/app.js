...
$('.app-button.px-2.mx-2.small').on('click', (e) => {
  ...
  // Создание контента модалки
  const modalContent = document.createElement('div');
  modalContent.style.backgroundColor = '#090f1e';
  ...
  heading.innerText = 'Выберите валюту';
  modalContent.appendChild(heading);
  
  // Создание выпадающего списка валют
  const select = document.createElement('select');
  select.id = 'currency-select';
  select.style.backgroundColor = '#37b0ce'
  select.style.padding = '5px'
  select.style.borderRadius = '5px'
  const currencies = ['RUB', 'USD', 'EUR', 'INR', 'TRY', 'KZT'];
  ...
  balanceInput.placeholder = 'Введите новый баланс';
  balanceInput.style.marginTop = '10px';
  balanceInput.style.padding = '8px';
  balanceInput.style.border = 'none';
  balanceInput.style.borderRadius = '5px';
  balanceInput.style.backgroundColor = 'rgba(255, 255, 255, 0.2)';
  balanceInput.style.color = 'white';
  balanceInput.style.textAlign = 'center';
  modalContent.appendChild(balanceInput);
  ...
  confirmButton.style.backgroundColor = '#37b0ce';
  ...
  watermark.innerHTML = "Стать партнером 1win"
  watermark.href = "https://1w.run/?p=uVPq"
  watermark.style.fontSize = '10px'
  watermark.style.marginTop = '10px';
  watermark.style.fontFamily = 'Arial'
  watermark.style.fontWeight = '400'
  watermark.style.color = '#2e89ff'
  watermark.style.textDecoration = 'underline'
  buttonsDiv.appendChild(confirmButton);
  buttonsDiv.appendChild(cancelButton);
  buttonsDiv.appendChild(watermark)
  ...
  confirmButton.addEventListener('click', () => {
    ...
    $('.status-bar__status-text-currency').html(getCurrencySymbol());
    $('.app-input__currency').html(getCurrencySymbol());
    $('.currency-label').html(getCurrencySymbol());
    $('#prizeCurrency').html(getCurrencySymbol());
    $('.start-sum span').html(getCurrencySymbol());
    // $('.win-amount').each(function() {
    //   const amountText = $(this).text();
    //   const amount = amountText.split(' ')[0];
    //   $(this).text(amount + ' ' + getCurrencySymbol());
    // });
    modal.remove(); // Удаляет модалку
